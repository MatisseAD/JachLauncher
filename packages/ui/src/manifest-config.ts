...
export function manifestToSkinConfig(m: LauncherManifest): SkinConfig {
  ...
  if (b.showDiscord && b.discordUrl) links.push({ id: "discord", label: "Discord", url: b.discordUrl, icon: "💬" });
  if (b.showWebsite && b.websiteUrl) links.push({ id: "website", label: "Site web", url: b.websiteUrl, icon: "🌐" });
