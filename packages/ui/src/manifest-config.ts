...
export function manifestToSkinConfig(m: LauncherManifest): SkinConfig {
  ...
  return {
    ...
    backgroundBlur: b.backgroundBlur,
    panelOpacity: b.panelOpacity,
    fontFamily: b.fontFamily,
    cornerRadius: b.cornerRadius,
    contentDensity: b.contentDensity,
    sidebarStyle: b.sidebarStyle,
    logoShape: b.logoShape,
    playButtonLabel: b.playButtonLabel,
    showServerStatus: b.showServerStatus,
    showNews: b.showNews,
    ambiance: b.ambiance,
