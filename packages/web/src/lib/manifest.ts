...
function resolveAssetUrl(stored: string | null, baseUrl: string): string | undefined {
 ...
 */
export function buildManifest(launcher: Launcher, baseUrl: string): LauncherManifest {
  const manifest = {
    ...
    branding: {
      ...
      visualStyle: launcher.visualStyle as LauncherManifest["branding"]["visualStyle"],
      buttonStyle: launcher.buttonStyle as LauncherManifest["branding"]["buttonStyle"],
      cardShape: launcher.cardShape as LauncherManifest["branding"]["cardShape"],
      menuPlacement: launcher.menuPlacement as LauncherManifest["branding"]["menuPlacement"],
