...
export function rowToForm(l: Launcher): LauncherFormData {
  return {
    ...
    backgroundFit: l.backgroundFit as LauncherFormData["backgroundFit"],
    backgroundPosition:
      l.backgroundPosition as LauncherFormData["backgroundPosition"],
    backgroundOverlay: l.backgroundOverlay,
    backgroundBlur: l.backgroundBlur,
    panelOpacity: l.panelOpacity,
    fontFamily: l.fontFamily as LauncherFormData["fontFamily"],
    cornerRadius: l.cornerRadius,
    contentDensity: l.contentDensity as LauncherFormData["contentDensity"],
    sidebarStyle: l.sidebarStyle as LauncherFormData["sidebarStyle"],
    logoShape: l.logoShape as LauncherFormData["logoShape"],
    playButtonLabel: l.playButtonLabel,
    showServerStatus: l.showServerStatus,
    showNews: l.showNews,
...
export function toCreateData(
  ...
  return {
    ...
    playButtonLabel: input.playButtonLabel,
    showServerStatus: input.showServerStatus,
...
export function toUpdateData(
  input: LauncherUpdate,
): Prisma.LauncherUncheckedUpdateInput {
