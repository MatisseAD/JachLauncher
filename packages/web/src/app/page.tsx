        ...
        <div className="hero-grid" style={{ position: "relative", zIndex: 1 }}>
          <div>
            <img
              ...
              width={132}
              height={132}
              style={{ display: "block", marginBottom: 18, filter: "drop-shadow(0 8px 30px rgba(139,92,246,0.45))" }}
            />
            <span className="eyebrow">⛏ {t.hero.badge}</span>
            <h1>
              {t.hero.titleLine1} <span className="grad">{t.hero.titleHighlight}</span> {t.hero.titleLine2}
            </h1>
            ...
            <div className="row wrap">
              ...
              <Link href="/preview/serveur-demo" className="btn secondary lg" target="_blank">
                {t.hero.ctaSecondary}
              </Link>
            </div>
            <div className="row wrap" style={{ gap: 22, marginTop: 26, color: "var(--text-dim)", fontSize: 13 }}>
