...
export default function NewsEditor({
  ...
  return (
    <div className="field">
      ...
      {items.length === 0 && (
        <div className="hint">
          Ajoute des actus pour que ton launcher ressemble à un vrai launcher de
          serveur.
        </div>
      )}
          ...
          <div className="row" style={{ alignItems: "flex-start", gap: 10 }}>
            <div style={{ flex: 1 }}>
              ...
              <input
                ...
                value={n.imageUrl ?? ""}
                onChange={(e) =>
                  update(i, { imageUrl: e.target.value || undefined })
                }
                style={{ marginTop: 8 }}
              />
              <div className="grid cols-3" style={{ gap: 10, marginTop: 8 }}>
                  ...
                  onChange={(e) =>
                    update(i, {
                      category: (e.target.value ||
                        undefined) as typeof n.category,
                    })
                  }
                >
                ...
                <label className="switch" style={{ margin: 0 }}>
                  <input
                    ...
                    checked={!!n.isNew}
                    onChange={(e) =>
                      update(i, { isNew: e.target.checked || undefined })
                    }
                  />
              ...
              <div className="grid cols-2" style={{ gap: 10, marginTop: 8 }}>
                ...
                <input
                  ...
                  value={n.buttonUrl ?? ""}
                  onChange={(e) =>
                    update(i, { buttonUrl: e.target.value || undefined })
                  }
                />
              </div>
            </div>
