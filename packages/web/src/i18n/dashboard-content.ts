...
const fr: DashboardCopy = {
  ...
  page: {
    ...
    hello: "Bonjour",
    intro:
      "Pilote tes launchers, suis leur utilisation et publie tes mises à jour depuis un seul espace.",
    newLauncher: "Nouveau launcher",
    ...
    drafts: "brouillons",
    loads: "Chargements",
    appSevenDays: "via l’application · 7 jours",
    content: "Contenus distribués",
    contentKinds: "mods, packs et shaders",
    playerActivity: "Activité joueurs",
    launcherLoads: "Chargements du launcher",
    sevenDays: "7 derniers jours",
    configOpenings: "ouvertures de configuration depuis l’application desktop",
    privateMetric: "Mesure agrégée, sans adresse IP ni identifiant joueur.",
...
const en: DashboardCopy = {
  ...
  page: {
    ...
    hello: "Hello",
    intro:
      "Manage your launchers, track usage and publish updates from one place.",
    newLauncher: "New launcher",
    limit: "Limit reached",
    launchers: "Launchers",
    available: "available",
    ...
    drafts: "drafts",
    loads: "Loads",
    appSevenDays: "through the app · 7 days",
    content: "Distributed content",
    contentKinds: "mods, packs and shaders",
    playerActivity: "Player activity",
    launcherLoads: "Launcher loads",
    sevenDays: "Last 7 days",
    configOpenings: "configuration loads from the desktop app",
    privateMetric:
      "Aggregated measurement, with no IP address or player identifier.",
...
const es: DashboardCopy = {
  ...
  page: {
    ...
    hello: "Hola",
    intro:
      "Gestiona tus launchers, consulta el uso y publica actualizaciones desde un solo lugar.",
    newLauncher: "Nuevo launcher",
    ...
    drafts: "borradores",
    loads: "Cargas",
    appSevenDays: "desde la aplicación · 7 días",
    content: "Contenido distribuido",
    contentKinds: "mods, packs y shaders",
    playerActivity: "Actividad de jugadores",
    launcherLoads: "Cargas del launcher",
    sevenDays: "Últimos 7 días",
    configOpenings: "cargas de configuración desde la app",
    privateMetric: "Medida agregada, sin IP ni identificador de jugador.",
...
const de: DashboardCopy = {
  ...
  page: {
    overview: "Übersicht",
    hello: "Hallo",
    intro: "Verwalte Launcher, Nutzung und Updates an einem Ort.",
    newLauncher: "Neuer Launcher",
    ...
    drafts: "Entwürfe",
    loads: "Ladevorgänge",
    appSevenDays: "über die App · 7 Tage",
    content: "Verteilte Inhalte",
    contentKinds: "Mods, Packs und Shader",
    playerActivity: "Spieleraktivität",
    launcherLoads: "Launcher-Aufrufe",
    sevenDays: "Letzte 7 Tage",
    configOpenings: "Konfigurationsaufrufe aus der Desktop-App",
    privateMetric: "Aggregiert, ohne IP-Adresse oder Spielerkennung.",
...
const pt: DashboardCopy = {
  ...
  page: {
    ...
    hello: "Olá",
    intro:
      "Gerencie launchers, acompanhe o uso e publique atualizações em um só lugar.",
    newLauncher: "Novo launcher",
    ...
    drafts: "rascunhos",
    loads: "Carregamentos",
    appSevenDays: "pelo aplicativo · 7 dias",
    content: "Conteúdo distribuído",
    contentKinds: "mods, packs e shaders",
    playerActivity: "Atividade dos jogadores",
    launcherLoads: "Carregamentos do launcher",
    sevenDays: "Últimos 7 dias",
    configOpenings: "configurações abertas no aplicativo",
    privateMetric: "Medição agregada, sem IP ou identificador.",
...
const it: DashboardCopy = {
  ...
  page: {
    overview: "Panoramica",
    hello: "Ciao",
    intro: "Gestisci launcher, utilizzo e aggiornamenti da un unico spazio.",
    newLauncher: "Nuovo launcher",
    ...
    drafts: "bozze",
    loads: "Caricamenti",
    appSevenDays: "tramite app · 7 giorni",
    content: "Contenuti distribuiti",
    contentKinds: "mod, pack e shader",
    playerActivity: "Attività giocatori",
    launcherLoads: "Caricamenti launcher",
    sevenDays: "Ultimi 7 giorni",
    configOpenings: "configurazioni aperte dall’app desktop",
    privateMetric: "Misura aggregata, senza IP o identificatore.",
